...
class _ColorPickerLabelState extends State<ColorPickerLabel> {
  ...
  Widget build(BuildContext context) {
    return SizedBox(height: 1.0, width: 1.0);
    ///Below line will not be shown as we do not needed RGB to show here
        ...
        SizedBox(
          ...
          child: TextField(
            ...
            inputFormatters: [
              ...
              FilteringTextInputFormatter.allow(RegExp(r'^#?[0-9a-fA-F]{1,6}')),
            ],
